...
export OSH='/home/visitor/.oh-my-bash'
...
# OMB_THEME_RANDOM_IGNORED=("agnoster" "amuse" "powerline-multiline" "Modern T")
...
read() {
  if [[ "$IS_MOBILE" == "true" ]]; then lynx "$1" -width=40; else lynx "$1"; fi
}
